...
class SSLValidationHandler(urllib_request.BaseHandler):
    ...
    def make_context(self, cafile, cadata, client_cert=None, client_key=None):
...
class Request:
    ...
    def open(self, method, url, data=None, headers=None, use_proxy=None,
        ...
        if ssl_handler and HAS_SSLCONTEXT and validate_certs:
            ...
            try:
                context = ssl_handler.make_context(tmp_ca_path, cadata, client_cert=client_cert, client_key=client_key)
            except NotImplementedError:
                pass
